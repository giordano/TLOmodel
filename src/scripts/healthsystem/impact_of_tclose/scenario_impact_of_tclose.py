...
```
tlo batch-submit src/scripts/healthsystem/impact_of_tclose/scenario_impact_of_tclose.py
```

or locally using:
```
tlo scenario-run src/scripts/healthsystem/impact_of_tclose/scenario_impact_of_tclose.py
```
