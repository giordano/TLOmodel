...
It can be submitted on Azure Batch by running:
   ...
   tlo batch-submit src/scripts/hiv/projections_jan2023/impact_of_Tb_DAH_baseline.py
or locally using:
 tlo scenario-run src/scripts/hiv/projections_jan2023/impact_of_Tb_DAH_baseline.py
  execute a single run:
 tlo scenario-run src/scripts/hiv/projections_jan2023/impact_of_Tb_DAH_baseline.py --draw 1 0

 check the batch configuration gets generated without error:
tlo scenario-run --draw-only src/scripts/hiv/projections_jan2023/impact_of_Tb_DAH_baseline.py

Job ID:impact_of_Tb_DAH_baseline-2023-06-14T133033Z
...
class ImpactOfTbDah(BaseScenario):
    ...
    def log_configuration(self):
        return {
            'filename': 'impact_of_Tb_DAH_baseline',
            'directory': './outputs',
            'custom_levels': {
                '*': logging.WARNING,
