...
cons_available .to_excel(outputpath / "cons_available_outRc.xlsx")
...
sample_deaths.to_excel(outputpath / "sample_mortality_outRc.xlsx")
...
ylds.to_excel(outputpath / "outRc.xlsx")
...
yll_output.to_excel(outputpath / "sample_yll_outRc.xlsx")
...
sample_dalys.to_excel(outputpath / "sample_dalys_outRc.xlsx")
...
TB_incidence.to_excel(outputpath / "new_TB_cases_outRc.xlsx")
...
TB_treatment_cov.to_excel(outputpath / "TB_treatment_outRcR.xlsx")
